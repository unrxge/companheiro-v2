...
- Don't narrate the feeling — earn it through the scene. If the prose has to tell the audience it was devastating, it already failed at devastating
...
- A turn, not a recounting: every section needs at least one point where the audience's assumption flips or deepens. Chronological retelling reads flat no matter how good the sentences are — the turn is what makes it eye-opening.
- Rhythm as a cut: vary sentence length on purpose; break a run of longer sentences on something short and blunt right at the moment of highest charge. It's the textual equivalent of a jump cut, and it's most of what keeps an audience from bouncing off.`

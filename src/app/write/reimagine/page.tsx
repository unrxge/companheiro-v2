      ...
      <div ref={threadRef} className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
        <div className="max-w-2xl mx-auto w-full space-y-6">
          ...
          {pendingLens && !isLoading && (
            <div className="flex justify-start">
              <div className="w-full bg-[#161614] border border-[#2e2d2a] rounded p-4 space-y-3">
                <p className="text-xs text-[#4a4946] uppercase tracking-widest">The lens</p>
                <p className="text-base text-[#d4d2cd] leading-relaxed">{pendingLens.lens}</p>

                <div className="space-y-1.5 pt-1">
                  <div className="flex justify-between text-xs text-[#6b6966]">
                    <span>{ENERGY_SCALE[0]}</span>
                    <span className="text-[#8c8a87] capitalize">{ENERGY_SCALE[energyIndex]}</span>
                  ...
                  <input
                    ...
                    className="w-full accent-[#e8e6e1]"
                  />
                </div>

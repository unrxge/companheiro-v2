...
// PUT: upsert a draft by id (client always supplies a pre-generated UUID).
// Using upsert means the first call creates the row and every subsequent
// call for the same session updates it — no race condition, no duplicates.
